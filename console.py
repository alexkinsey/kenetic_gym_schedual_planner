...
attendance2 = Attendance(fitness_class1, customer3)
attendance_repo.save(attendance2)
attendance3 = Attendance(fitness_class1, customer4)
attendance_repo.save(attendance3)
attendance4 = Attendance(fitness_class2, customer2)
attendance_repo.save(attendance4)
attendance5 = Attendance(fitness_class2, customer3)
attendance_repo.save(attendance5)
attendance6 = Attendance(fitness_class3, customer5)
attendance_repo.save(attendance6)
attendance7 = Attendance(fitness_class4, customer2)
attendance_repo.save(attendance7)
attendance8 = Attendance(fitness_class4, customer1)
